            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        ...
                        <img src="<?php echo base_url('storage/users/default.png') ?>" width="100px" alt="" class="img-preview">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <select name="level" id="" class="form-control">
                            <option value="1" <?php echo (set_value('level') == 1 ? "selected" : "") ?>>Admin</option>
                            <option value="2" <?php echo (set_value('level') == 2 ? "selected" : "") ?>>Karyawan</option>
